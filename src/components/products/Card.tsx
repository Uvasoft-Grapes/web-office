    ...
    <>
      <div onClick={()=>setOpenDetails(true)} className="card flex flex-wrap gap-2 min-h-36 bg-secondary-light dark:bg-secondary-dark hover:bg-primary-light dark:hover:bg-primary-dark duration-300 cursor-pointer">
        <div className="flex flex-wrap gap-2 min-w-full">
          ...
          <span className="flex-1 flex items-center justify-center text-center font-semibold text-xs sm:text-sm px-4 py-1 rounded-full text-primary-dark dark:text-primary-light bg-tertiary-light dark:bg-tertiary-dark">{category.label || "Sin categoría"}</span>
        </div>
      ...
      {openDetails && <>
        <div className="flex flex-wrap gap-2 min-w-full">
          ...
          <span className="flex-1 flex items-center justify-center text-center font-semibold text-sm sm:text-base px-4 py-1 rounded-full text-primary-light dark:text-primary-dark bg-primary-dark dark:bg-primary-light">{category.label || "Sin categoría"}</span>
        </div>
