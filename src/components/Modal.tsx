...
export default function Modal({ children, isOpen, onClose, title }:{ children:ReactNode, isOpen:boolean, onClose:()=>void, title:string }) {
  ...
  return(
    <div className="fixed top-0 left-0 right-0 z-50 flex justify-center items-center w-full h-screen max-h-full overflow-y-auto overflow-x-hidden bg-primary-dark/50 dark:bg-primary-light/50">
