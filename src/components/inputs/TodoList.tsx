  ...
  return(
    <div className="flex flex-col gap-1">
      ...
      {todoList.map((todo, index) => (
        <li key={index} className="flex justify-between gap-3 px-3 py-2 my-0.5 rounded-md bg-primary-light dark:bg-primary-dark hover:bg-tertiary-light dark:hover:bg-tertiary-dark border border-tertiary-light dark:border-tertiary-dark duration-300">
          ...
          <button type="button" onClick={() => handleDeleteOption(index)} className="h-fit cursor-pointer">
            <HiOutlineTrash className="text-lg text-basicr:text-red-dark duration-300"/>
          </button>
        </li>
      ))}
      </ul>
      <div className="flex items-center gap-2">
        <input
          ...
          className="w-full px-3 py-3 outline-none rounded-md font-medium text-sm text-basicondary-dark focus-within:bg-primary-light dark:focus-within:bg-primary-dark border border-tertiary-light dark:border-tertiary-dark placeholder:text-quaternary/50 duration-300"
        />
