      ...
      :
        <div className="flex items-center justify-center">
          <div className="flex w-full">
            <form onSubmit={(e)=>handleSubmit(e)} className="form-card col-span-3 w-full">
              ...
              <div className="mt-4">
                <label htmlFor="" className="text-sm font-semibold text-quaternary">Título</label>
                <input
                  type="text"
              ...
              <div className="mt-3">
                <label htmlFor="" className="text-sm font-semibold text-quaternary">Descripción</label>
                <textarea
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-2">
                <div className="">
                  <label htmlFor="" className="text-sm font-semibold text-quaternary">Prioridad</label>
                  <SelectDropdown
                ...
                <div className="">
                  <label htmlFor="" className="text-sm font-semibold text-quaternary">Fecha de entrega</label>
                  <input
                    type="date"
                    placeholder="Fecha"
                ...
                <div className="col-span-1 sm:col-span-2 lg:col-span-1">
                  <label htmlFor="" className="text-sm font-semibold text-quaternary">Participantes</label>
                  <SelectUsers
              ...
              <div className="mt-3">
                <label className="text-sm font-semibold text-quaternary">Lista de pendientes</label>
                <TodoListInput
              ...
              <div className="mt-3">
                <label htmlFor="" className="text-sm font-semibold text-quaternary">Añadir anexos</label>
                <AttachmentInput
